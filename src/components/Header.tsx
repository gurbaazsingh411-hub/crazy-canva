...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 w-full p-4 flex justify-between items-center z-50 pointer-events-none">
            <h1 className="text-3xl font-pixel neon-text tracking-widest pointer-events-auto bg-black/50 px-2 py-1 border border-transparent hover:border-neon-green transition-colors rounded">CRAZY CANVAS</h1>
